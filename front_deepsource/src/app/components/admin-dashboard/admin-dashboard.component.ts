...
export class AdminDashboardComponent implements OnInit {
  ...
  static esAdmin(roles: string[] | undefined): boolean {
  ...
  colorTipo(tipo: string): string { return AdminDashboardComponent.colorTipo(tipo); }
  esAdmin(roles: string[] | undefined): boolean { return AdminDashboardComponent.esAdmin(roles); }
}
