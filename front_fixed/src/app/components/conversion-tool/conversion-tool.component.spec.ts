...
describe('ConversionToolComponent', () => {
  ...
  const crearFile = (nombre: string, tipo: string, contenido = 'x') =>
  ...
  // ── convertir – validaciones previas ─────────────────────────────────
  ...
  it('procesarArchivo recjaza un archivo de tipo incorrecto (imagen en audio)', () => {
